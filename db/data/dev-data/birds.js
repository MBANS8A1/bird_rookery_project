...
module.exports = [
    ...
    },
    {
     ...
     },
     {
        ...
        diet: ['insects','rodents','scorpions','tarantulas','centipedes','small-reptiles','small birds'],
        can_Fly : true,
        length_cm: 60,
        weight_g: 390,
        lay_season: 'spring/summer/autumn',  
     ...
     },
     {
        ...
        diet: ['insects', 'grains','molluscs','amphibians','berries','seeds','rodents'],
        can_Fly : true,
        length_cm: 95,
        weight_g: 5000,
     ...
     },
     {
        ...
        diet: ['insects','earthworms','small-reptiles','amphibians','rodents','grains','flowers','crucifers','grasses'],
        can_Fly : true,
        length_cm: 120,
        weight_g: 6800,
     ...
     },
     {
        ...
        diet: ['insects','small-birds','seeds','fruit','mice','leaves','small-reptiles'],
        can_Fly : true,
        length_cm: 100,
        weight_g: 7000,
        lay_season: 'autumn',  
   ...
   },
   {
      ...
      diet: ['fruit','berries','nuts','molluscs','insects','spiders','nectar'],
      can_Fly : true,
      length_cm:20,
      weight_g: 55,
      lay_season: 'spring/summer',  
   ...
   },
   {
      ...
      diet: ['berries','insects','spiders','caterpillars','earthworms','mollusc'],
      can_Fly : true,
      length_cm:21,
      weight_g: 43,
      lay_season: 'spring/summer',  
   ...
   },
   {
      ...
      diet: ['seeds','roots','fruits','insects','roots','small-reptiles','molluscs'],
      can_Fly : false,
      length_cm:136,
      weight_g: 2300,
      lay_season: 'summer/autumn/winter',  
   ...
   },
   {
      ...
      diet: ['fruit','fungi','molluscs','rodents','insects','fish','amphibians'],
      can_Fly : false,
      length_cm:170,
      weight_g: 44000,
      lay_season: 'summer/autumn',  
   ...
   },
   {
      ...
      lay_season: 'spring/summer',  
      family : "Tytonidae",
      fun_fact :'These owls hunt by sound rather than sight using their heart-shpaed feather on the edge of their face in order to trap sound; they pais mate for life and when they are flying they are completely silent',
      order: "Strigiformes",
      wingspan_cm: 90
   },
   {
      ...
      diet: ['smaller-birds','fish','amphibians','insects','scorpions','crustaceans','carrion','small-mammals'],
      can_Fly : true,
      length_cm:64,
      weight_g: 1400,
      lay_season: 'spring',  
   ...
   },
   {
      ...
      diet: ['rodents','small-birds','amphibians','insects','earthworms','crustaceans'],
      can_Fly : true,
      length_cm:38,
      weight_g: 770,
      lay_season: 'spring',  
