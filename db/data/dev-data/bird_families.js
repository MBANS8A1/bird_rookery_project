module.exports = [
    {
        scientific_fam_name: "Coloumbidae",
        description: "They are known crop pests and in urbunareas they nest on man-made structues and their droppings tend to be a nuisance. Tend to be granivorous and frugivorous",
        clutch_size : '[1,2]',
        habitats: ["grasslands","mountains","forests","coastal"],
        predators: ["reptiles","birds of prey"]
    },
    {
        scientific_fam_name: "Alcedinidae",
        description: "Their habitats are under threat due to human encroachment, logging, pollution and increased development; they have been known to take fish from privately owned fish farms or garden ponds.",
        clutch_size : '[3,6]',
        habitats: ["grasslands","mountains","forests","coastal","lakes","ponds"],
        predators: ["birds of prey","larger mammals","reptiles"]
    },
    {
        scientific_fam_name: "Meropidae",
        description: "Birds of this family are insectivores so they are good pest control farmers but nos so good for apiarists",
        clutch_size : '[2,6]',
        habitats: ["woodlands","near arid riverbeds"],
        predators: ["reptiles"]
    },
    {
        scientific_fam_name: "Todidae",
        description: "They are found on the 4 Caribbean islands of Puerto Rico, Jamaica, Hispaniola and Cuba; their undersides are washed with light shades of various colurs such as yellow, green, red and blue. But dispite their vibrancy they sit so still that they are hard to see.",
        clutch_size : '[2,4]',
        habitats: ["island rainforests"],
        predators: ["mongooses"]
    },
    {
        scientific_fam_name: "Eurypygidae",
        description: "There is only one species in this family and the key representative is the Sunbittern. They perform courtship dances with tails and wings open. They have unsually large 'eyespots' that are visible when their wings are open",
        clutch_size : '[2,3]',
        habitats: ["swamps","forests"],
        predators: ["larger mammals","birds of prey"]
    },
    {
        scientific_fam_name: "Rhynochetidae",
        description: "These are ash-white flightless birds that are found on New Caledonia. Important to the Kanak tribe who saw these birds as a source of meat and their feathers were worn by chiefs ",
        clutch_size : '[2,3]',
        habitats: ["swamps","forests"],
        predators: ["larger mammals","birds of prey"]
    },
    ...
    },
    {
        ...
        description: "These are the New WOrld quails in the Americas that are short-winged, short-necked and short-tailed. THey are capable of strong bursts of flight but prefer to wlak or run away and hide from danger.The chicks are born precocial(in an advanced state) and quickly leave the nest to accompany the parents in large groups",
        clutch_size : '[10,15]',
        habitats: ["hardwood forests","grasslands","savanna","rainforests","arid scrublands"],
        predators:["birds of prey","larger mammals","reptiles","human hunters"]
    },
    {
        scientific_fam_name: "Gruidae",
        description: "These are the groupf cranes that have long legs and log necks. and fly with their necks outstretched. They tend to constuct their nests near to shallow waters. They are found on all continents except Antarctica and South America. THey can be sedentary or migratory are not very territorial. Most species of cranes have been affected by human activities in a negative fashion. Both parents raise the chicks and stay with them until the next breeding season",
        clutch_size : '[2,3]',
    ...
    },
    {
        ...
        description: "These are the group of diving birds (the size of ducks and geese) with small pointed wings, tapered bills and webs between the front three toes that tend to be aquatic residing and are excellent swimmers.The young from the group moult down into a second group of down feathers after shedding the first group. They have difficulty becoming airbourne and must gain enough velocity from wind currents to do so. To aid digestion they swallow small pebbles at the bottom of large bodies of water",
        clutch_size : '[1,2]',
        habitats: ["lakes","ponds","oceans"],
        predators:["seagulls","larger mammals"]
    },
    {
        scientific_fam_name: "Musophagidae",
        description: "The name for this family of birds literraly means ;'banana-eaters'; Musophagids are medium-sized birds endemin in sub-Saharan Africa; they are noted for the unique pigments (e.g. turacins and carotenoids derived from porphyrins) and bright green and red feathers. They are weak fliers but strong tree and canopy climbers and as a result they are nimble on trees and branches. They are semi-zygodactylous meaning that their fourth (outer) toe can be switched back and forth",
        clutch_size : '[2,3]',
        habitats: ["forests","woodlands","savanna"],
        predators:["birds of prey","larger mammals"]
    },
    {
        scientific_fam_name: "Mesitornithidae",
        description: "These are a family of small near-flightless birds endemic to Madagascar. Every species in this family (white, brown and sub-desert) is threatened. THey are vocal birds that produce passerine-like sounds for territorial defence",
        clutch_size : '[2,3]',
    ...
    {
        scientific_fam_name: "Mesitornithidae",
        description: "These mesites are a family of small near-flightless birds endemic to Madagascar. Every species in this family (white, brown and sub-desert) is threatened. THey are vocal birds that produce passerine-like sounds for territorial defence",
        clutch_size : '[2,3]',
        habitats: ["dry forests","woodlands"],
        predators:["reptiles","larger mammals"]
    },
    ...
    },
    {
        ...
        description: "This family includes comorants and shags.They breed in colonies ranging from a few hundreds of thousands of pairs. These birds regurgitate the food they eat (fish bones and scales). They stand with wings extended and adopt postures and techniques to improve thremoregulation such as gular-flutterring. Their guano is collected at their colonie sites as fertilizer",
        clutch_size : '[2,6]',
        habitats: ["seacoasts"],
        predators:["birds of prey"]
    },
    ...
    },
    {
        ...
        description: "These are large water birds where the beak is modified with a throat pouch for catching prey and draining water that is scooped up. Their plumage is pale/white. The species in this family tend to nest on the ground or close to it; these birds have a gregarious nature meaning they like travelling, hunting and breeding as a cooperative with other Pelecanidae of the same species.These birds have membranous air sacs subcutaneously but the mechanism of how they inflate them in unknown but is thought to help with buoyancy.",
        clutch_size : '[2,4]',
        habitats: ["inland waters","coastal waters"],
        predators:["humans","other mammals"]
    },
    {
        ...
        clutch_size : '[0,1]',
        habitats: ["tropical and subtropical oceans","coastal waters"],
        predators:["humans","other mammals"]
    },
    {
        scientific_fam_name: "Fregatidae",
    ...
    },
    {
        ...
        description: "These are the near passerine Jacamars of Central and South America that are closely related to puffbirds. These are aerial insectivores with short wide bills. Their feets are no so strong and their feet are zygodactylic (two-forward-pointing toes and two backward-pointing). They also have iridescent plumage with males having a white patch on the breast ara",
        clutch_size : '[1,4]',
        habitats: ["forests","woodlands","streams"],
        predators:["none"]
    },
    {
        scientific_fam_name: "Galbulidae",
        description: "These are the near passerine Jacamars of Central and South America that are closely related to puffbirds. These are aerial insectivores with short wide bills. Their feets are no so strong and their feet are zygodactylic (two-forward-pointing toes and two backward-pointing). They also have iridescent plumage with males having a white patch on the breast area",
        clutch_size : '[1,4]',
        habitats: ["forests","woodlands","streams"],
        predators:["none"]
    },
