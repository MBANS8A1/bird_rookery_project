const bird_familyD = [
  {
    ...
    f_description:
      "They are known crop pests and in urbun areas they nest on man-made structures and their droppings tend to be a nuisance. Tend to be granivorous and frugivorous",
    clutch_size: "[1,2]",
  ...
  },
  {
    ...
    f_description:
      "Their habitats are under threat due to human encroachment, logging, pollution and increased development; they have been known to take fish from privately owned fish farms or garden ponds.",
    clutch_size: "[3,6]",
    habitats: [
      "grasslands",
      "mountains",
  ...
  },
  {
    ...
    f_description:
      "Birds of this family are insectivores so they are good pest control farmers but not so good for apiarists",
    clutch_size: "[2,6]",
  ...
  },
  {
    ...
    f_description:
      "They are found on the 4 Caribbean islands of Puerto Rico, Jamaica, Hispaniola and Cuba; their undersides are washed with light shades of various colurs such as yellow, green, red and blue. But dispite their vibrancy they sit so still that they are hard to see.",
    clutch_size: "[2,4]",
  ...
  },
  {
    ...
    f_description:
      "There is only one species in this family and the key representative is the Sunbittern. They perform courtship dances with tails and wings open. They have unsually large 'eyespots' that are visible when their wings are open",
    clutch_size: "[2,3]",
  ...
  },
  {
    ...
    f_description:
      "These are ash-white flightless birds that are found on New Caledonia. Important to the Kanak tribe who saw these birds as a source of meat and their feathers were worn by chiefs ",
    clutch_size: "[2,3]",
    habitats: ["swamps", "forests"],
    predators: ["larger mammals", "birds of prey"],
    order: "Eurypygiformes",
  ...
  },
  {
    ...
    f_description:
      "This family refers to the group of mousebirds which is a groupf brownish-grey bird with hairlike body feathers. They are arboreal and scurry through the leaves and brush like rodents in search of their prey/food. They can feed upside down and have pamprodactyl feed in they have reversible outer toes.",
    clutch_size: "[2,4]",
  ...
  },
  {
    ...
    f_description:
      "These are the New World quails in the Americas that are short-winged, short-necked and short-tailed. THey are capable of strong bursts of flight but prefer to walk or run away and hide from danger.The chicks are born precocial(in an advanced state) and quickly leave the nest to accompany the parents in large groups",
    clutch_size: "[10,15]",
    habitats: [
      "hardwood forests",
      "grasslands",
  ...
  },
  {
    ...
    f_description:
      "The name for this family of birds literraly means ;'banana-eaters'; Musophagids are medium-sized birds endemin in sub-Saharan Africa; they are noted for the unique pigments (e.g. turacins and carotenoids derived from porphyrins) and bright green and red feathers. They are weak fliers but strong tree and canopy climbers and as a result they are nimble on trees and branches. They are semi-zygodactylous meaning that their fourth (outer) toe can be switched back and forth",
    clutch_size: "[2,3]",
  ...
  },
  {
    ...
    f_description:
      "These are large water birds where the beak is modified with a throat pouch for catching prey and draining water that is scooped up. Their plumage is pale/white. The species in this family tend to nest on the ground or close to it; these birds have a gregarious nature meaning they like travelling, hunting and breeding as a cooperative with other Pelecanidae of the same species.These birds have membranous air sacs subcutaneously but the mechanism of how they inflate them in unknown but is thought to help with buoyancy.",
    clutch_size: "[2,4]",
  ...
  },
  {
    ...
    f_description:
      "These are the near passerine Jacamars of Central and South America that are closely related to puffbirds. These are aerial insectivores with short wide bills. Their feets are no so strong and their feet are zygodactylic (two-forward-pointing toes and two backward-pointing). They also have iridescent plumage with males having a white patch on the breast ara",
    clutch_size: "[1,4]",
  ...
  },
  {
    ...
    f_description:
      "This family contains chickadees, tits and titmice. They are grouped according to their abilities to cache food. Some parts of their brains are adapted so that they cam remember locations of where they retrieved food. THey fly short distances in a bounding motion and are not so brightly coloured overall, except with a few having white or yellow colouration on their breasts. These are coomonly the birds that are attracted to bird feeders. They have short cone-shaped beaks covered in bristles and specialized leg muscles for hanging upside down on tree branches.",
    clutch_size: "[10,15]",
  ...
  },
  {
    ...
    f_description:
      "These are the group of Old World parrots with vivid plumage colours, strong curved bills and clawed zygodactyl feet. They mainly eat grains, fruit and other plant material. They are known for their high intelligence and ability ot imitate human voices. But they have been impacted negatively via hunting, habitat loss, invasive species and the illegal pet trade. While they do fly they like hopping to locations too in order to move around their environment",
    clutch_size: "[1,9]",
  ...
  },
  {
    ...
    f_description:
      "These group of birds are part of the Africa and New World parrots. They have bright plumage and are popular pets. They ahve strong beaks capable of cracking the hardest seeds and nuts, which they manipualte with dextrous feet that displays zygodactyly that woodpeckers and cuckoos have. They are very cocal and usually pair for life with their partner",
    clutch_size: "[1,11]",
    habitats: ["woodlands", "savanna"],
    predators: ["birds of prey"],
    order: "Psittaciformes",
  ...
  },
  {
    ...
    f_description:
      "These large flightless birds are found in the tropical forests of New Guinea, nearby islands and in northern Australia. Mainly they are frugivores but will eat seeds and fungi too. THey are shy but can provoke injuries of on domesticated mammals if provoked. Their wings are short and reduced to stiff keratin-rich quills. All of their feathers consist of a shaft and loose barbules. On their heads are soft and spongy crests called casques, which they use to push through underbrush and for settling disputes with other birds of the same species. Their necks are shades of blue, red and sometimes yellow",
    clutch_size: "[8,10]",
